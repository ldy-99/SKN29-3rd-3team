...
> 서비스 기획 단계에서 청약 초보자의 핵심 여정을 정의하고 React 화면과 사용자 흐름을 구현하며, 진단, 결과 확인, 이력 조회를 자연스럽게 이어갈 수 있도록 UI를 정리했습니다. API 응답 구조와 화면 표현이 잘 맞아야 사용자가 복잡한 청약 정보를 부담 없이 이해할 수 있다는 점을 배웠습니다.
