"""
역할: Django 공개 API 서버의 전체 설정 파일입니다.
흐름: manage.py/asgi/wsgi -> settings.py -> installed apps, DB, CORS, DRF, FastAPI 연결 설정.
주의: FASTAPI_API_URL, CORS/CSRF origin, SECRET_KEY는 환경변수 기준으로 운영에서 분리해야 합니다.
"""
"""
